...
namespace FandG
{
    public partial class zielony : Form
    {
        bool goLeft, goRight;
        int speed = 3;
        ...
        private void MainGameTimer(object sender, EventArgs e)
        {
            ...
            if (goLeft == true && player.Left > 1)
            {
                ...
                player.BackgroundImage = Properties.Resources.zie_lewy1; //zmiana obrazu gracza na "lewy"
            ...
            if (goRight == true && player.Left + player.Width < this.ClientSize.Width)
            {
                ...
                player.BackgroundImage = Properties.Resources.zie_prawy1; //zmiana obrazu gracza na "prawy"
                player.BackgroundImageLayout = ImageLayout.Stretch;
            }
            ...
            foreach (Control x in this.Controls)
            {
                ...
                if (x is PictureBox && ((string)x.Tag == "can" || (string)x.Tag == "bottle" || (string)x.Tag == "core"))
                {
                    ...
                    if (x.Top + x.Height > this.ClientSize.Height)
                    {
                        ...
                        {
                            trash_hit.BackgroundImage = Properties.Resources.but_zbita;
                            ...
                            missed += 1;
                            player.BackgroundImage = Properties.Resources.zie_zbity1; //w sensie jak ominie jakiegos smiecia co mial zebrac
                            player.BackgroundImageLayout = ImageLayout.Stretch;
                        }
                    ...
                    if (player.Bounds.IntersectsWith(x.Bounds))
                    {
                        ...
                        else if ((string)x.Tag == "can" || (string)x.Tag == "core")
                        {
                            x.Top = randY.Next(50, 100) * -1;
                            x.Left = randX.Next(10, this.ClientSize.Width - x.Width);
                            missed += 1;
