...
namespace FandG
{
    public partial class brazowy : Form
    {
        bool goLeft, goRight;
        int speed = 3;
        ...
        private void MainGameTimer(object sender, EventArgs e)
        {
            ...
            labMissed.Text = "Missed: " + missed; //wyswietlanie zmiennej missed w labelu 
            ...
            if (goLeft == true && player.Left > 1)
            {
                ...
                player.BackgroundImage = Properties.Resources.br_lewy1; //zmiana obrazu gracza na "lewy"
            ...
            if (goRight == true && player.Left + player.Width < this.ClientSize.Width)
            {
                ...
                player.BackgroundImage = Properties.Resources.br_prawy2; //zmiana obrazu gracza na "prawy"
                player.BackgroundImageLayout = ImageLayout.Stretch;
            }
            ...
            foreach (Control x in this.Controls)
            {
                ...
                if (x is PictureBox && ((string)x.Tag == "can" || (string)x.Tag == "bottle" || (string)x.Tag == "core"))
                {
                    ...
                    {
                        if ((string)x.Tag == "core")
                        {
                            trash_hit.BackgroundImage = Properties.Resources.jablko_zbite;
                            ...
                            missed += 1;
                            player.BackgroundImage = Properties.Resources.br_zbity1; //w sensie jak ominie jakiegos smiecia co mial zebrac
                            player.BackgroundImageLayout = ImageLayout.Stretch;
                        }

                        else if ((string)x.Tag == "can")
                        {
                    ...
                    if (player.Bounds.IntersectsWith(x.Bounds))
                    {
                        ...
                        else if ((string)x.Tag == "can" || (string)x.Tag == "bottle")
                        {
                            x.Top = randY.Next(50, 100) * -1;
                            x.Left = randX.Next(10, this.ClientSize.Width - x.Width);
                            missed += 1;
